...
namespace SkladApp
{
    ...
    {
        private string connectionString = @"Data Source=DESKTOP-7GJ7CVV\MSSQLSERVER01;Initial Catalog=sklad;Integrated Security=True";
        ...
        private void btnSearchByCoords_Click_1(object sender, EventArgs e)
        {
            try
            {
